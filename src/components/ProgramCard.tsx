...
const ProgramCard: React.FC<ProgramCardProps> = ({ src, judul, deskripsi }) => {
  return (
    <div className="md:w-[300px] p-8 bg-white shadow-lg cursor-pointer hover:bg-green-50 hover:shadow-xl transition-shadow duration-300 rounded-xl flex flex-col items-center text-center space-y-5">
